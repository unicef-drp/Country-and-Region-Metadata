...
dt_rec <- data.table(
  Region = c(
    rep("Arab Maghreb Union (UMA)", 5),
    rep("Common Market for Eastern and Southern Africa (COMESA)", 19),
    rep("Community of Sahel-Saharan States (CEN-SAD)", 29),
    rep("East African Community (EAC)", 5),
    rep("Economic Community of Central African States (ECCAS)", 10),
    rep("Economic Community of West African States (ECOWAS)", 15),
    rep("Intergovernmental Authority on Development (IGAD)", 8),
    rep("Southern African Development Community (SADC)", 15)
  ),
  Country = c(
    # UMA
