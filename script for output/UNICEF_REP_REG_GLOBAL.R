...
dt_in[!ISO3Code %in% dc$ISO3Code]
# Regional_Grouping                  Region Region_Code  Country ISO3Code
# <char>                  <char>      <char>   <char>   <char>
#   1: UNICEF_REP_REG_GLOBAL   East Asia and Pacific  UNICEF_EAP  Tokelau      TKL
# 2: UNICEF_REP_REG_GLOBAL Europe and Central Asia  UNICEF_ECA Holy See      VAT
